...
\begin{enumerate}
    ...
    \begin{item}
        ...
        \begin{enumerate}
            \item permanently through indication to the administration team;
            \item temporarily through suspension, to be decided by the administration team or unanimous vote;
            \item permanently through expulsion, to be decided by unanimous vote.
        \end{enumerate}
    \end{item}
    ...
    \begin{item}
        ...
        \begin{enumerate}
            \item Suspended members retain their obligations, but lose their rights, including their voting right and their right to access Wyvern services;
            \item The duration of the suspension is at most until the next Wyvern meeting, at which the suspension is to be prolonged or lifted;
